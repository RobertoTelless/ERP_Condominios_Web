...
namespace ModelServices.EntitiesServices
{
    public class TelefoneService : ServiceBase<TELEFONE>, ITelefoneService
    {
        ...
        private readonly IRamoAtividadeRepository _ramoRepository;
        protected Erp_CondominioEntities Db = new Erp_CondominioEntities();

        public TelefoneService(ITelefoneRepository baseRepository, ILogRepository logRepository, ICategoriaTelefoneRepository catRepository, IRamoAtividadeRepository ramoRepository) : base(baseRepository)
        {
        ...
        public List<RAMO_ATIVIDADE> GetAllRamos()
        {
            return _ramoRepository.GetAllItens(0);
        }
