    ...
    public class UsuarioAppService : AppServiceBase<USUARIO>, IUsuarioAppService
    {
        ...
        public Int32 ValidateCreate(USUARIO usuario, USUARIO usuarioLogado)
        {
            try
            {
                ...
                usuario.COND_CD_ID = usuarioLogado.COND_CD_ID;
                ...
                LOG log = new LOG
                {
                    ...
                    COND_CD_ID = usuarioLogado.COND_CD_ID,
        ...
        public Int32 CreateNotificacao(NOTIFICACAO noti, USUARIO usuarioLogado)
        {
            ...
            {
                //Completa campos
                USUARIO adm = _usuarioService.GetAdministrador(usuarioLogado.COND_CD_ID);
                noti.COND_CD_ID = usuarioLogado.COND_CD_ID;
                noti.CANO_CD_ID = 1;
                ...
                CONFIGURACAO conf = _usuarioService.CarregaConfiguracao(usuarioLogado.COND_CD_ID);
        ...
        public Int32 ValidateLogin(String login, String senha, out USUARIO usuario)
        {
            try
            {
                ...
                if (!retorno)
                {
                    if (usuario.USUA_NR_FALHAS <= _usuarioService.CarregaConfiguracao(usuario.COND_CD_ID).CONF_NR_FALHAS_DIA)
                    {
                    ...
                    else if (usuario.USUA_NR_FALHAS > _usuarioService.CarregaConfiguracao(usuario.COND_CD_ID).CONF_NR_FALHAS_DIA)
                    {
        ...
        public Int32 ValidateChangePassword(USUARIO usuario)
        {
            try
            {
                ...
                usuario.COND_CD_ID = usuario.COND_CD_ID;

                // Gera Notificação
                NOTIFICACAO noti = new NOTIFICACAO();
                noti.CANO_CD_ID = 1;
                noti.COND_CD_ID = usuario.COND_CD_ID;
        ...
        public Int32 GenerateNewPassword(String email)
        {
            ...
            log.COND_CD_ID = usuario.COND_CD_ID;
            ...
            // Prepara e-mail e enviar
            CONFIGURACAO conf = _usuarioService.CarregaConfiguracao(usuario.COND_CD_ID);
            Email mensagem = new Email();
